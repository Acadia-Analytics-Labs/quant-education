...
$$P(B_1 | G) = \frac{P(G | B_1)\cdot P(B_1)}{P(G)} = \frac{\frac{5}{10}\cdot \frac{1}{2}}{\frac{12}{20}} = 0.417$$

$$P(B_2 | G) = \frac{P(G | B_2)\cdot P(B_2)}{P(G)} = \frac{\frac{7}{10}\cdot \frac{1}{2}}{\frac{12}{20}} = 0.583$$
